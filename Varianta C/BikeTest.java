...
class BikeFactory {
    ...
    public BikeFactory(int capacity){
        this.bikesArr = new Bike[capacity]; this.totalBikesProduced = 0;
    }


    public int getTotalBikesProduced() {
        return totalBikesProduced;
    }

    public void setTotalBikesProduced(int totalBikesProduced) {
        this.totalBikesProduced = totalBikesProduced;
    }

    public void produceBike(String model, double price){
        if(getTotalBikesProduced() < (365*12/1.5)) {
